...
var _logic = __webpack_require__(9);

var _guesses = __webpack_require__(10);

var _guess = __webpack_require__(11);
...
var Game = exports.Game = function () {
    function Game() {
        ...
        this.logic = new _logic.Logic(this);
        this.guesses = new _guesses.Guesses();
        this.guess = new _guess.Guess(this);

        this.player.onNameSet.then(function () {
            return _this.start();
        });
    ...
    _createClass(Game, [{
        ...
        value: function render() {
            this.components.map(function (c) {
                return c && typeof c.render === 'function' && c.render();
            });
        }
    }, {
        key: 'start',
        ...
        key: 'onGuessed',
        value: function onGuessed(num, guess) {
...
var Player = exports.Player = function () {
    function Player() {
        ...
        this.onNameSet = new Promise(function (resolve, reject) {
        ...
        this.onNameSet.then(function (name) {
            _this.name = name;
            _this.render();
        });
    }
    ...
    _createClass(Player, [{
        key: 'render',
        value: function render() {
            var elements = $('#name-input, #start-button');
...
var Logic = exports.Logic = function () {
    ...
    _createClass(Logic, [{
        ...
        value: function startGame() {
            ...
            this.secretGuess = function (num) {
                return secretNumber < num ? 'less' : secretNumber > num ? 'greater' : 'correct';
            };
        }
    }, {
        key: 'guess',
        value: function guess(num) {
            ...
            if (this.secretGuess && typeof this.secretGuess === 'function') {
                setTimeout(function () {
                    return _this.game.onGuessed(num, _this.secretGuess(num));
                }, 400);
            }
        }
    }]);
...
var Guesses = exports.Guesses = function () {
    function Guesses() {
    ...
    _createClass(Guesses, [{
        key: 'addGuess',
        value: function addGuess(num, value) {
            if (num && value) {
                this.guesses.push({ num: num, value: value });
                this.render();
            }
        }
    }, {
        ...
        value: function render() {
            ...
            $('#guesses tbody').append(this.guesses.map(function (g, i) {
...
var Guess = exports.Guess = function () {
    function Guess(game) {
        _classCallCheck(this, Guess);

        $('#guess-form').on('submit', function (e) {
            e.preventDefault();
            var value = parseInt($('#guess-input').val());
            if (!isNaN(value) && value > 0 && value <= 100) game.onGuessing(value);
            $('#guess-form')[0].reset();
        });
        $('#guess-form')[0].reset();
    ...
    _createClass(Guess, [{
        ...
        key: 'render',
        value: function render() {
            var elements = $('#guess-input, #guess-button');
            if (!this.enabled) {
                elements.attr('disabled', 'disabled');
            } else {
                elements.removeAttr('disabled');
